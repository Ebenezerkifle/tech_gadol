...
class _$ProductsStateImpl implements _ProductsState {
  ...
  @override
  String toString() {
    return 'ProductsState(isLoading: $isLoading, selectedProduct: $selectedProduct, errorMessage: $errorMessage, total: $total, skip: $skip, limit: $limit)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, selectedProduct,
      errorMessage, total, skip, limit);
...
abstract class _ProductsState implements ProductsState {
  const factory _ProductsState(
      ...
      final int total,
      final int skip,
      final int limit}) = _$ProductsStateImpl;
